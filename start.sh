...
PORT="${PORT:-4420}"
DB_NAME="${PGDATABASE:-advanced_industry_research_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Advanced Industry Research Suite"
echo "======================================="
echo
...
echo "Starting advanced industry research suite frontend on http://localhost:$PORT"
echo "Login: admin@advanced-industry.local / admin123"
