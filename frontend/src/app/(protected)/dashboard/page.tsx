...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Advanced Industry Research Dashboard"
      subtitle="One merged advanced industry research view for Research Programs, Lab Notes, Experiments, Grants, IP Pipeline, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared advanced industry research jobs into one surface. Research Programs, Lab Notes, Experiments, Grants, IP Pipeline, Publications, documents, audit, and AI are presented as platform features.</div>
