...
const featureSeeds = [
  ['research-programs', 'Research Programs', 'Research Programs operating queue', 'Research Lead', 'Review and assign next action'],
  ['lab-notes', 'Lab Notes', 'Lab Notes operating queue', 'Research Lead', 'Review and assign next action'],
  ['experiments', 'Experiments', 'Experiments operating queue', 'Research Lead', 'Review and assign next action'],
  ['grants', 'Grants', 'Grants operating queue', 'Research Lead', 'Review and assign next action'],
  ['ip-pipeline', 'IP Pipeline', 'IP Pipeline operating queue', 'Operations Lead', 'Review and assign next action'],
  ['publications', 'Publications', 'Publications operating queue', 'Operations Lead', 'Review and assign next action'],
  ['simulations', 'Simulations', 'Simulations operating queue', 'Operations Lead', 'Review and assign next action'],
  ['materials', 'Materials', 'Materials operating queue', 'Operations Lead', 'Review and assign next action'],
  ['equipment', 'Equipment', 'Equipment operating queue', 'Governance Lead', 'Review and assign next action'],
  ['safety', 'Safety', 'Safety operating queue', 'Governance Lead', 'Review and assign next action'],
  ['collaborations', 'Collaborations', 'Collaborations operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
