export const AUTH_COOKIE = 'advanced_industry_research_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@advanced-industry.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@advanced-industry.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@advanced-industry.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
