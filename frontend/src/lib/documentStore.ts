...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Research Programs Packet', type: 'Research Programs', owner: 'Research Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Lab Notes Review Bundle', type: 'Lab Notes', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Experiments Evidence Set', type: 'Experiments', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
