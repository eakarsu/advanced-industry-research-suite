...
const seed: NotificationItem[] = [
  { id: 'note-1', title: 'Research Programs alert', detail: 'Research Programs queue needs review.', read: false },
  { id: 'note-2', title: 'Lab Notes approval due', detail: 'Lab Notes exception list needs approval.', read: false },
  { id: 'note-3', title: 'Experiments updated', detail: 'Experiments operating queue was refreshed.', read: true },
];
